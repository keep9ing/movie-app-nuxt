export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid:'og:site_name', property: 'og:site_name', content: 'Nust Movie App'},
      ...
      { hid:'og:image', property: 'og:image', content: 'https://heropy.blog/css/image/logo.png'},
      { hid:'og:url', property: 'og:url', content: process.env.CLIENT_URL }
    ],
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
      { rel: 'preconnect', href:'https://fonts.googleapis.com' },
      { rel: 'preconnect', href:'hhttps://fonts.gstatic.com',crossorigin: true },
